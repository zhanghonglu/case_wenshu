...
class case_info(models.Model):
    case_no = models.CharField(verbose_name="文件编号",max_length=50,primary_key=True)
    ...
    residence = models.CharField(verbose_name="居住地", max_length=20, blank=True)
    ...
    civil_plaintiff = models.CharField(verbose_name="附带民事诉讼原告",max_length=20, blank=True)
    public_prosecutor = models.CharField(verbose_name="公诉人",max_length=20,blank=True)
    def __str__(self):
        return self.case_no
